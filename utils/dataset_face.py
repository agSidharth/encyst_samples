...
def load_labels(PATH,SIZE = 70000):
...
def get_random_sampling(size = 70000):
    ...
    y = load_labels('ffhq_labels.csv',SIZE)
    X,y = shuffle(X,y)
...
def data_loader(transform = None, batch_size = 32,num_workers = 0,size = 70000):
    ...
    train_data,train_label,val_data,val_label = get_random_sampling(size)
